namespace SyntaxTest.Exercises
{
    ...
    {
        /*
          Parašykite viešą eilutės tipo (string) propertį (savybę, property), kurio pavadinimas yra MyName. Šis propertis turi turėti viešą geterį ir viešą seterį.
          Properčių vardai yra rašomi iš didžiosios raidės. Toks rašymo būdas vadinamas "Pascal Case".
